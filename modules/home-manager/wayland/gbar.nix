  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.gBar = {
      ...
      extraConfig = ''
        ...
        WidgetsCenter: [Time]
        WidgetsRight: [Tray, Audio, Bluetooth CPU, RAM, Power]
        IconsAlwaysUp: true
        SensorTooltips: true
      '';
      extraCSS = ''
    ...
    systemd.user.services.gbar = {
      Unit = {
        Description = "gBar service.";
        Documentation = "https://github.com/scorpion-26/gBar";
      ...
      Service = {
        ExecStart = "${inputs.gBar.defaultPackage.x86_64-linux}/bin/gBar bar 0";
        Restart = "on-failure";
      };
    };
  };
